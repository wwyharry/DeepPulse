...
def query_kline(code: str, days: int = 60, source: str = None) -> str:
    ...
    df = _query.get_daily_kline(code, start_date=str(start), end_date=str(end), source=source, limit=int(days))
    if df.empty:
...
def verify_prediction(prediction_id: str, actual_price: float, actual_return_pct: float = 0) -> str:
    ...
    """
    return _memory.prediction_tracker.verify_prediction(prediction_id, actual_price, actual_return_pct)
...
TOOL_DEFINITIONS = [
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "top_n": {"type": "integer", "description": "返回前N个板块，默认10"},
                },
                "required": [],
            },
        },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "days": {"type": "integer", "description": "分析的交易日数量，默认60"},
                },
                "required": ["code"],
            },
        },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "actual_return_pct": {
                        "type": "number",
                        "description": "实际收益率（百分比，如5.2表示涨5.2%）",
                        "default": 0,
                    },
                },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "key": {
                        "type": "string",
                        "description": "画像维度: trading_style(交易风格)/risk_tolerance(风险偏好)/preferred_indicators(偏好指标)/watched_sectors(关注板块)/stop_loss_habit(止损习惯)/position_sizing(仓位习惯)/trading_frequency(交易频率)",
                    },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "entity_type": {
                        "type": "string",
                        "description": "实体类型（可选）: stock/indicator/pattern/strategy/concept/rule",
                        "default": "",
                    },
                    "relation_type": {
                        "type": "string",
                        "description": "关系类型（可选）: triggers/requires/contradicts/supports/applies_to/user_prefers",
                        "default": "",
                    },
                },
                "required": [],
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "source_type": {
                        "type": "string",
                        "description": "源实体类型: stock/indicator/pattern/strategy/concept/rule",
                    },
                    "target_name": {"type": "string", "description": "目标实体名称（如'低吸战法'）"},
                    "target_type": {
                        "type": "string",
                        "description": "目标实体类型: stock/indicator/pattern/strategy/concept/rule",
                    },
                    "relation_type": {
                        "type": "string",
                        "description": "关系类型: triggers(触发)/requires(需要)/contradicts(矛盾)/supports(支持)/applies_to(适用于)/user_prefers(用户偏好)",
                    },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "strategy": {
                        "type": "string",
                        "description": "策略: ma_cross(macd_cross)/rsi_oversold/volume_breakout/boll_bounce/kdj_cross/multi_confirm",
                        "default": "macd_cross",
                    },
    ...
    },
    {
        ...
        "function": {
            ...
            "parameters": {
                "type": "object",
                "properties": {"trade_date": {"type": "string", "description": "日期YYYYMMDD，默认今天"}},
                "required": [],
            },
        },
    },
    ...
    },
    {
        ...
        "function": {
            ...
            "parameters": {
                "type": "object",
                "properties": {"group": {"type": "string", "description": "按分组筛选", "default": ""}},
                "required": [],
            },
        },
    },
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "rule_type": {
                        "type": "string",
                        "description": "告警类型: price_above/price_below/pct_change/volume_spike/rsi_zone",
                        "enum": ["price_above", "price_below", "pct_change", "volume_spike", "rsi_zone"],
                    },
    ...
    },
    {
        ...
        "function": {
            ...
            "parameters": {
                "type": "object",
                "properties": {"limit": {"type": "integer", "description": "返回条数", "default": 20}},
                "required": [],
            },
        },
    },
    ...
    },
    {
        ...
        "function": {
            ...
            "parameters": {
                "type": "object",
                "properties": {"days": {"type": "integer", "description": "查看天数", "default": 7}},
                "required": [],
            },
        },
    },
